...
::: {.grid .team-member}
::: {.g-col-12 .g-col-md-3}
![](photoYeJi.jpg){fig-alt="Photo of Dr. Ye-Ji Kim"}
:::
...
::: {.grid .team-member}
::: {.g-col-12 .g-col-md-3}
![](photoChristi.jpg){fig-alt="Photo of Christi Sagariya"}
:::
...
::: {.grid .team-member}
::: {.g-col-12 .g-col-md-3}
![](photoDavid.jpg){fig-alt="Photo of David Chludil"}
:::
...
::: {.grid .team-member}
::: {.g-col-12 .g-col-md-3}
![](photoSarath.jpg){fig-alt="Photo of Sarath Saravanasakthi"}
:::
...
[Research Gate](https://example.com) | [Email](mailto:saravanasakthi@fld.czu.cz)
:::
:::
